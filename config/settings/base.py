...
MIGRATION_MODULES = {"sites": "platform_django.contrib.sites.migrations"}
...
STATICFILES_DIRS = [
    str(APPS_DIR / "static"),
    str(BASE_DIR / "apps" / "platform_django" / "dist"),
    str(BASE_DIR / "apps" / "landing" / "dist"),
]
...
ADMINS = [("""Mike Ascah""", "mike-ascah@example.com")]
# https://docs.djangoproject.com/en/dev/ref/settings/#managers
MANAGERS = ADMINS
# https://platform-django-template.readthedocs.io/en/latest/1-getting-started/settings.html#other-environment-settings
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "platform_django.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "platform_django.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "platform_django.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "platform_django.users.forms.UserSocialSignupForm"}
